...
const Post = ({ post }) => {
    ...
    return (
        <>
            <div className='flex gap-2 items-start p-4 border-b  border-r border-l border-gray-700'>
                ...
                <div className='flex flex-col flex-1'>
                    ...
                    <div className='flex justify-between mt-3'>
                        <div className='flex gap-4 items-center w-2/3 justify-between'>
                            ...
                            >
                                <IoChatbubblesOutline className='w-4 h-4  text-slate-500 group-hover:text-sky-400' />
                            ...
                            {/* Repost section start */}
                            <div className='flex gap-1 items-center group cursor-pointer'>
                                <IoRepeatOutline className='w-6 h-6  text-slate-500 group-hover:text-green-500' />
                        ...
                        <div className='flex w-1/3 justify-end gap-2 items-center'>
                            <IoBookmarkOutline className='w-4 h-4 text-slate-500 cursor-pointer' />
                        </div>
                        {/* Save section end */}
